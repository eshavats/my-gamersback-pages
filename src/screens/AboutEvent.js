                    ...
                    <div className="about-content">
                        <div className="row">
                            ...
                            <div className="column">
                                ...
                                <button  
                                className="btn btn-outline-danger btn-block register-now" >
                        ...
                        <h1 className="head">Prize Pool</h1>
                        <h2 className="about-heading2">How much will you win?</h2>
                        ...
                        <div className="startTime">
                            <h1 className="head">Event Start Time</h1>
                            <h2 className="about-heading2">Time to take out the consoles!</h2>
